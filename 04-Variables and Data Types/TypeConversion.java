/**********************************************************************
  ...
  Programmer : Roy Felix Ng
  Contact Details : j24041393@student.newinti.edu.my
...
public class TypeConversion {
    public static void main(String[] args) {
        ...
        System.out.println("Result after calculate without conversion: " + intVar2 + " (" + Double.BYTES + " bytes)");
		System.out.println("Result after explicit conversion from double to int: " + intVar3 + " (" + Integer.BYTES + " bytes)");

        // Conversion between char and int
        char letter = 'A';     // character
        int asciiValue = letter; // implicit conversion (char to int)
        System.out.println("\nChar to Int Conversion:");
        System.out.println("Character: " + letter + " (" + Character.BYTES + " bytes)");
        System.out.println("ASCII value: " + asciiValue + " (" + Integer.BYTES + " bytes)");

        int number = 66;
        char convertedChar = (char) number; // explicit conversion (int to char)
        System.out.println("\nInt to Char Conversion:");
        System.out.println("Integer: " + number + " (" + Integer.BYTES + " bytes)");
        System.out.println("Converted to char: " + convertedChar + " (" + Character.BYTES + " bytes)");
    }
}
